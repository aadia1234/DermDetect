...
trainingSet = trainDatagen.flow_from_directory(trainFolder, target_size=(IMAGE_SIZE[0], IMAGE_SIZE[1]), batch_size=80, class_mode="categorical")
testSet = testDatagen.flow_from_directory(testFolder, target_size=(IMAGE_SIZE[0], IMAGE_SIZE[1]), batch_size=40, class_mode="categorical")
...
result = model.fit(trainingSet, validation_data = testSet, epochs = 100, steps_per_epoch = 10, validation_steps = 10, callbacks=[checkpoint_callback, earlystop_callback])
